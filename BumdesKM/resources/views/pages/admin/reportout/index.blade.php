...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Report Out</h1>
    </div>
    <form action="/tgl" method="post" style="margin-bottom: 1rem;">
        @csrf
        <div class="row g-3 align-items-center">
            ...
            <div class="col-auto">
                ...
                <button class="btn btn-danger">
                    <a href="/admin/reportout" style="text-decoration: none; color:white;">Back</a>
                </button>
            </div>
        </div>
    </form>
