...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Transaction In {{ $item->product->title }}</h1>
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('transactionin.update', $item->id) }}" method="POST">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <label for="tgl_masuk">Tanggal Masuk</label>
                    <input type="date" class="form-control" name="tgl_masuk" placeholder="Tanggal Masuk" value="{{ $item->tgl_masuk }}">
                </div>
                <div class="form-group">
                    <label for="id_product">Product</label>
                    <select name="id_product" id="id_product" required class="form-control">
                        <option value="{{ $item->id_product }}">Jangan DiUbah</option>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group-prepend">
                        ...
                        <input type="number" class="form-control" name="hrg_beli" id="hrg_beli" value="{{ $item->hrg_beli }}" >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group-prepend">
                        <input type="number" class="form-control" name="jml_stok" id="jml_stok" placeholder="Qty" value="{{ $item->jml_stok }}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="basic-addon1">Rp.</span>
                        <input type="number" class="form-control" name="hrg_total" id="hrg_total" placeholder="Total" value="{{ $item->hrg_total }}" readonly>
                    </div>
                </div>
