...
class TransaksiController extends Controller
{
    ...
    public function index()
    {
        ...
        $transaksi = DB::table('table_transaksi')
            ...
            ->join('table_petugas', 'table_transaksi.id_petugas', '=', 'table_petugas.id_petugas')
    ...
    {
        if (Petugas::where('id_petugas', $request->id_petugas)->count() > 0) {
            ...
            return json_encode('Petugas tidak ditemukan');
        }
    }
...

    {
        ...
        $pinjaman = DB::table('table_transaksi')
            ...
            ->join('table_petugas', 'table_petugas.id_petugas', '=', 'table_transaksi.id_petugas')
