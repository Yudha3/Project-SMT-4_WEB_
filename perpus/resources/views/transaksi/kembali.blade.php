    ...
    <div class="jumbotron">
        ...
        <form action="{{ action('TransaksiController@update', $pinjaman->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="id_petugas" name="id_petugas" value="{{ $pinjaman->id_petugas }}" readonly="true">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_petugas" name="nama_petugas" readonly="true" value="{{ $pinjaman->nama_petugas }}">
...
<script>
    $(function() {
        ...
        $('#id_petugas').on('change', function(e) {
            ...
            let url = $(this).data('url') + '/transaksi/getPetugas/' + id_petugas;
