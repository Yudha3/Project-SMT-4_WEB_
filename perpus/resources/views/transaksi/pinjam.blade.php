    ...
    <div class="jumbotron">
        ...
        <form action="/transaksi" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="id_petugas" name="id_petugas" placeholder="ID Petugas" data-url="{{ url('/') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_petugas" name="nama_petugas" readonly="true">
